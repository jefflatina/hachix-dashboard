...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="home" style = "color:white"><i class="fa fa-dashboard"></i> Home</a></li>

      <li class="active" style = "color:white">Create Sale</li>
                ...
                <div class="box">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <span class="input-group-addon"><button type="button" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#modalAddCustomer" data-dismiss="modal">Add More</button></span>
      ...
      <div class="col-lg-7 hidden-md hidden-sm hidden-xs">
          ...
          <div class="box box-default">
            ...
            <div class="box-body">
              ...
              <table class="table table-bordered table-hover dt-responsive salesTable">
