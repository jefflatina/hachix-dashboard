<header class="main-header">
	...
	<a href="home" class="logo">
		...
		<span class="logo-mini">
			...
			<img class="img-responsive" src="views/img/template/logohachix.png" style="padding: 10px" >
		...
		<span class="logo-lg">
			...
			<img class="img-responsive" src="views/img/template/hachixheader.png" style="padding: 5px 0" >
